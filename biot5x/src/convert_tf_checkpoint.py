...
%run 'BioT5X/convert_tf_checkpoint.py' \
 --gin_file="BioT5X/configs/t5/t5_1_0/base.gin" \
 --gin.DROPOUT_RATE=0.0\
 --gin.convert_checkpoint.model=%MODEL\
 --gin.convert_checkpoint.tf_checkpoint_path="'gs://scifive/models/pubmed/base/model.ckpt-2000000'"\
 --gin.convert_checkpoint.output_dir="'t5x_checkpoints/biot5x'"
